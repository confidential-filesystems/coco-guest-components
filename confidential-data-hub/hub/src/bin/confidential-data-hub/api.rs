...
#[derive(PartialEq,Clone,Default,Debug)]
// @@protoc_insertion_point(message:api.DeleteResourceRequest)
pub struct DeleteResourceRequest {
    // message fields
    // @@protoc_insertion_point(field:api.DeleteResourceRequest.ResourcePath)
    pub ResourcePath: ::std::string::String,
    // @@protoc_insertion_point(field:api.DeleteResourceRequest.Resource)
    pub Resource: ::std::vec::Vec<u8>,
    // special fields
    // @@protoc_insertion_point(special_field:api.DeleteResourceRequest.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl DeleteResourceRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ResourcePath",
            |m: &DeleteResourceRequest| { &m.ResourcePath },
            |m: &mut DeleteResourceRequest| { &mut m.ResourcePath },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "Resource",
            |m: &DeleteResourceRequest| { &m.Resource },
            |m: &mut DeleteResourceRequest| { &mut m.Resource },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<DeleteResourceRequest>(
...
impl ::protobuf::Message for DeleteResourceRequest {
    ...
    fn default_instance() -> &'static DeleteResourceRequest {
        static instance: DeleteResourceRequest = DeleteResourceRequest {
            ResourcePath: ::std::string::String::new(),
            Resource: ::std::vec::Vec::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
...
impl ::protobuf::MessageFull for DeleteResourceRequest {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("DeleteResourceRequest").unwrap()).clone()
    }
}

impl ::std::fmt::Display for DeleteResourceRequest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
#[derive(PartialEq,Clone,Default,Debug)]
// @@protoc_insertion_point(message:api.DeleteResourceResponse)
pub struct DeleteResourceResponse {
    // message fields
    // @@protoc_insertion_point(field:api.DeleteResourceResponse.Response)
    pub Response: ::std::vec::Vec<u8>,
    // special fields
    // @@protoc_insertion_point(special_field:api.DeleteResourceResponse.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl DeleteResourceResponse {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "Response",
            |m: &DeleteResourceResponse| { &m.Response },
            |m: &mut DeleteResourceResponse| { &mut m.Response },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<DeleteResourceResponse>(
...
impl ::protobuf::Message for DeleteResourceResponse {
    const NAME: &'static str = "DeleteResourceResponse";
    ...
    fn default_instance() -> &'static DeleteResourceResponse {
        static instance: DeleteResourceResponse = DeleteResourceResponse {
            Response: ::std::vec::Vec::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
...
impl ::protobuf::MessageFull for DeleteResourceResponse {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("DeleteResourceResponse").unwrap()).clone()
    }
}

impl ::std::fmt::Display for DeleteResourceResponse {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    equest\x12\"\n\x0cResourcePath\x18\x01\x20\x01(\tR\x0cResourcePath\x12\
    \x1a\n\x08Resource\x18\x02\x20\x01(\x0cR\x08Resource\"4\n\x16DeleteResou\
    rceResponse\x12\x1a\n\x08Response\x18\x01\x20\x01(\x0cR\x08Response2V\n\
    \x13SealedSecretService\x12?\n\x0cUnsealSecret\x12\x16.api.UnsealSecretI\
    nput\x1a\x17.api.UnsealSecretOutput2\xe0\x01\n\x0fResourceService\x12@\n\
    \x0bGetResource\x12\x17.api.GetResourceRequest\x1a\x18.api.GetResourceRe\
    sponse\x12@\n\x0bSetResource\x12\x17.api.SetResourceRequest\x1a\x18.api.\
    SetResourceResponse\x12I\n\x0eDeleteResource\x12\x1a.api.DeleteResourceR\
    equest\x1a\x1b.api.DeleteResourceResponseb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(DeleteResourceRequest::generated_message_descriptor_data());
            messages.push(DeleteResourceResponse::generated_message_descriptor_data());
