...
pub struct GetResourceRequest {
    ...
    // @@protoc_insertion_point(field:getresource.GetResourceRequest.ExtraCredential)
    pub ExtraCredential: ::std::string::String,
    // special fields
...
impl ::protobuf::Message for GetResourceRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    self.ExtraCredential = is.read_string()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.ExtraCredential.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.ExtraCredential);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.ExtraCredential.is_empty() {
            os.write_string(4, &self.ExtraCredential)?;
        }
    ...
    fn default_instance() -> &'static GetResourceRequest {
        static instance: GetResourceRequest = GetResourceRequest {
            ...
            ExtraCredential: ::std::string::String::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11getresource.proto\x12\x0bgetresource\"\x94\x01\n\x12GetResourceReq\
    uest\x12\"\n\x0cResourcePath\x18\x01\x20\x01(\tR\x0cResourcePath\x12\x18\
    \n\x07KbcName\x18\x02\x20\x01(\tR\x07KbcName\x12\x16\n\x06KbsUri\x18\x03\
    \x20\x01(\tR\x06KbsUri\x12(\n\x0fExtraCredential\x18\x04\x20\x01(\tR\x0f\
    ExtraCredential\"1\n\x13GetResourceResponse\x12\x1a\n\x08Resource\x18\
    \x01\x20\x01(\x0cR\x08Resource2f\n\x12GetResourceService\x12P\n\x0bGetRe\
    source\x12\x1f.getresource.GetResourceRequest\x1a\x20.getresource.GetRes\
    ourceResponseb\x06proto3\
";
